    ...
    public function index_action()
    {
        ...
        foreach ($status_infos as $status_info){
            if(User::find($status_info->user_id)){
                ...
                $status_info->delete(); //zugeh�rigen Nutzer gibt es nicht mehr
        }
    ...
    public function problemdelete_action()
    {
        ...
        foreach ($status_infos as $status_info){
            ...
            if($single_dozent && UserConfig::get($status_info->user_id)->getValue(EXPIRATION_DATE)){
                ...
                //Konflikt wurde behoben und Account kann wieder in L�schroutine aufgenommen werden
                ...
                if ($status_info){
                    ...
                    foreach($seminare_dozent as $membership){
                     ...
                     //falls kein Seminar existiert in welchem dieser Nutzer einziger Dozent ist: Account l�schen
                        ...
                        //zur�cksetzen f�r standard l�sch-prozess (status == 2)
                        $status_info->account_status = 2;
                        $status_info->store();
                    }
                }
