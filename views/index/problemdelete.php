...
<ul>
    ...
    <li>ignorieren (Account wird nicht geöscht werden)</li>
</ul>
    </p>
...
<?php foreach ($data as $d){ ?>
     <? foreach ($d['seminare'] as $membership): ?>
        <tr>
            ...
            <td>
                <a href='<?=URLHelper::getLink("/seminar_main.php?auswahl=" . $membership->seminar_id )?>' target="_blank" title="Zur Veranstaltung">
